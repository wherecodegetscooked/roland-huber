...
import globalConnection from '../assets/images/global-connection.png';
...
export const HomePage: React.FC<HomePageProps> = ({ navigateTo }) => {
  return (
    <>
      ...
      <section className="bg-white py-10 sm:py-14" aria-label="Our global connection">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <img
            src={globalConnection}
            alt="RKHConsulting connects Africa and the Middle East with Switzerland and China"
